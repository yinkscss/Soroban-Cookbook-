...
This section contains Architecture Decision Records (ADRs) for the Soroban Cookbook project.
...
5. Add the new ADR to the index table above and in [`docs/adr/README.md`](../../docs/adr/README.md)
